...
Auto download:
```Powershell
curl -o "Invoke-WindowsSetup.ps1" "https://raw.githubusercontent.com/ALFinternet/windows-setup/refs/heads/main/core/Invoke-WindowsSetup.ps1"
```

Script phase (Invoke-WindowsSetup.ps1):
```Powershell
